				...
				{({ ref }) => (
					<div ref={ref}>
						...
						>
							...
							<div style={{display:'flex', width:'100%', flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems:'center'}}>
			
							<ListItemText
				className="list-item-text"
				primary={item.title}
				classes={{ primary: 'text-14 list-item-text-primary' }}
			/>								<div style={{width:'100%', height:3, backgroundColor: isUrlInChildren(item, props.location.pathname) ? '#3D85C6' : 'rgba(0,0,0,0)'}}>
