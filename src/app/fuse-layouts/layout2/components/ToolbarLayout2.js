...
const useStyles = makeStyles(theme => ({
	root: {
		boxShadow: '0 0 0 0 rgba(0, 0, 0, 0.24)'
	}
}));
	...
	return (
		<ThemeProvider theme={toolbarTheme}>
			<AppBar
				...
				elevation={2}
			>
				<Toolbar className="flex flex-auto justify-between items-center w-full h-full container p-0 lg:px-24 min-h-48 md:min-h-64">
